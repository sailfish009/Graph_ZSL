"""
Implementation of DOGRE / WOGRE approach, as explained in the pdf file which is in our github page.
...
import time
from oger_embedding.state_of_the_art_embedding import final
from math import pow
from oger_embedding.utils import get_initial_proj_nodes_by_k_core, get_initial_proj_nodes_by_degrees
import heapq
...
def one_iteration(params, dict_enode_proj, dict_node_enode, dict_enode_node, dict_node_node_in, dict_node_node_out,
    ...
    if params.size < 10:
        ...
        final_proj = calculate_projection_weighted(current_node, embd_neigh_in, embd_neigh_out, dict_enode_proj, dict_enode_enode_in,
                                          dict_enode_enode_out, dim, params, G)
...
def main_D_W_OGRE(G, initial_method, method, initial, dim, params, choose="degrees", regu_val=0, weighted_reg=False):
    """
    Main Function
    ...
    return list_dicts, set_no_proj, times
